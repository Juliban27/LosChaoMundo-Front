  ...
  const validateField = (name, value) => {
    ...
    switch (name) {
      ...
      case "correo":
        ...
        else if (!emailRegex.test(value)) error = "Correo electrónico inválido";
        break;
      case "contrasena":
    ...
    <div className="min-h-screen flex items-center justify-center bg-[#9ec5ff] p-4">
      <div className="w-full max-w-md bg-[#e0edff] rounded-3xl shadow-2xl p-6 sm:p-8 relative overflow-hidden">
        ...
        <div className="relative text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-[#150063] mb-1">Crear Cuenta</h1>
              ...
              <div className="relative">
                ...
                {field.type === "select" ? (
                  <select
                    ...
                    className={`w-full pl-11 pr-4 py-3 rounded-lg border transition-all duration-200 bg-[#e0edff] focus:ring-2 focus:ring-[#1d4ed8]/60 ${
                      errors[field.name]
                  ...
                  <input
                    ...
                    className={`w-full pl-11 pr-12 py-3 rounded-lg border transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-[#1d4ed8]/60 ${
                      errors[field.name]
                        ? "border-red-300 focus:ring-red-500"
                        : "border-[#b2c9ff]"
                    }`}
